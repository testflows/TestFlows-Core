...
from testflows._core.cli.arg.handlers.report.metrics.openmetrics import Handler as openmetrics_handler

class Handler(HandlerBase):
    @classmethod
    def add_command(cls, commands):
        parser = commands.add_parser("metrics", help="metrics report", epilog=epilog(),
            description="Generate metrics report for a test run.",
