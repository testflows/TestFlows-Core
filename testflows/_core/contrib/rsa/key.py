...
class PublicKey(AbstractKey):
    ...
    def _load_pkcs1_der(cls, keyfile: bytes) -> 'PublicKey':
        ...
        from testflows._core.contrib.pyasn1.codec.der import decoder
        from testflows._core.contrib.rsa.asn1 import AsnPubKey
    ...
    def _save_pkcs1_der(self) -> bytes:
        ...
        from testflows._core.contrib.pyasn1.codec.der import encoder
        from testflows._core.contrib.rsa.asn1 import AsnPubKey
    ...
    def load_pkcs1_openssl_der(cls, keyfile: bytes) -> 'PublicKey':
        ...
        from testflows._core.contrib.rsa.asn1 import OpenSSLPubKey
        from testflows._core.contrib.pyasn1.codec.der import decoder
...
class PrivateKey(AbstractKey):
    ...
    def _save_pkcs1_der(self) -> bytes:
        ...
        from testflows._core.contrib.pyasn1.type import univ, namedtype
        from testflows._core.contrib.pyasn1.codec.der import encoder
    ...
    @property
    def pubkey(self):
        """Returns public key that corresponds to this private key.
...
def find_p_q(nbits: int,
    ...
    >>> (p, q) = find_p_q(128)
    >>> from testflows._core.contrib.rsa import common
    >>> common.bit_size(p * q)
    256
...
def newkeys(nbits: int,
    ...
    if poolsize > 1:
        from testflows._core.contrib.rsa import parallel
