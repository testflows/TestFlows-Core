"""
Inspired by the Auto-Playwright project, this module provides a way to automate web tasks using AI.

https://github.com/lucgagan/auto-playwright/blob/main/LICENSE - MIT License
"""
